...
try:
    from warnings import deprecated # PARAVIEW_DEPRECATED_IN_6_0_0
except ImportError: # XXX(python-3.13): warnings.deprecated is new
    class deprecated:
        ...
        def __call__(self, arg, /):
            msg = self.message
            stacklevel = 1
            # Pull support for classes from CPython 3.13 if necessary.
            if callable(arg):
                import functools
                import inspect
                ...
                def wrapper(*args, **kwargs):
                    warn(msg, category=DeprecationWarning, stacklevel=stacklevel + 1)
                ...
                raise TypeError(
                    ...
                    f"or callable, not {arg!r}"
                )



__version__ = '6.0.0'
__version_full__ = '6.0.0'
...
class options:
    ...
    @deprecated("Use `satellite` instead (since 6.0.0)")
    def satelite(self):

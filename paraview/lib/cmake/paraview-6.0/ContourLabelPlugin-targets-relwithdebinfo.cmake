...
set_target_properties(ContourLabelRepresentation::ContourLabelRepresentation PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/ContourLabelPlugin/vtkContourLabelPlugin.lib"
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/ContourLabelPlugin/vtkContourLabelPlugin.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ContourLabelRepresentation::ContourLabelRepresentation )
list(APPEND _IMPORT_CHECK_FILES_FOR_ContourLabelRepresentation::ContourLabelRepresentation "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/ContourLabelPlugin/vtkContourLabelPlugin.lib" "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/ContourLabelPlugin/vtkContourLabelPlugin.dll" )

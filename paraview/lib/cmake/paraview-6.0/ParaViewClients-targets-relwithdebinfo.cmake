...
set_target_properties(ParaView::ClientsWeb PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/vtkPVClientWeb-pv6.0.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "ParaView::RemotingApplication;ParaView::RemotingViews;VTK::CommonSystem"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/vtkPVClientWeb-pv6.0.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ParaView::ClientsWeb )
list(APPEND _IMPORT_CHECK_FILES_FOR_ParaView::ClientsWeb "${_IMPORT_PREFIX}/lib/vtkPVClientWeb-pv6.0.lib" "${_IMPORT_PREFIX}/bin/vtkPVClientWeb-pv6.0.dll" )
...
set_target_properties(ParaView::Catalyst PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/vtkPVCatalyst-pv6.0.lib"
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/vtkPVCatalyst-pv6.0.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ParaView::Catalyst )
list(APPEND _IMPORT_CHECK_FILES_FOR_ParaView::Catalyst "${_IMPORT_PREFIX}/lib/vtkPVCatalyst-pv6.0.lib" "${_IMPORT_PREFIX}/bin/vtkPVCatalyst-pv6.0.dll" )
...
set_target_properties(ParaView::PythonCatalyst PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/vtkPVPythonCatalyst-pv6.0.lib"
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/vtkPVPythonCatalyst-pv6.0.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ParaView::PythonCatalyst )
list(APPEND _IMPORT_CHECK_FILES_FOR_ParaView::PythonCatalyst "${_IMPORT_PREFIX}/lib/vtkPVPythonCatalyst-pv6.0.lib" "${_IMPORT_PREFIX}/bin/vtkPVPythonCatalyst-pv6.0.dll" )
...
set_target_properties(ParaView::InSitu PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/vtkPVInSitu-pv6.0.lib"
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/vtkPVInSitu-pv6.0.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS ParaView::InSitu )
list(APPEND _IMPORT_CHECK_FILES_FOR_ParaView::InSitu "${_IMPORT_PREFIX}/lib/vtkPVInSitu-pv6.0.lib" "${_IMPORT_PREFIX}/bin/vtkPVInSitu-pv6.0.dll" )

...
set_target_properties(SLACTools::vtkSLACFilters PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/SLACTools/vtkSLACFilters.lib"
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/SLACTools/vtkSLACFilters.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS SLACTools::vtkSLACFilters )
list(APPEND _IMPORT_CHECK_FILES_FOR_SLACTools::vtkSLACFilters "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/SLACTools/vtkSLACFilters.lib" "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/SLACTools/vtkSLACFilters.dll" )

...
set_target_properties(Prism::vtkPrismFilters PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismFilters.lib"
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismFilters.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS Prism::vtkPrismFilters )
list(APPEND _IMPORT_CHECK_FILES_FOR_Prism::vtkPrismFilters "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismFilters.lib" "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismFilters.dll" )
...
set_target_properties(Prism::vtkPrismViews PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismViews.lib"
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismViews.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS Prism::vtkPrismViews )
list(APPEND _IMPORT_CHECK_FILES_FOR_Prism::vtkPrismViews "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismViews.lib" "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismViews.dll" )
...
set_target_properties(Prism::vtkPrismServerManager PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismServerManager.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "ParaView::RemotingCore;VTK::CommonCore;VTK::CommonDataModel"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismServerManager.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS Prism::vtkPrismServerManager )
list(APPEND _IMPORT_CHECK_FILES_FOR_Prism::vtkPrismServerManager "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismServerManager.lib" "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismServerManager.dll" )
...
set_target_properties(Prism::vtkPrismReaders PROPERTIES
  IMPORTED_IMPLIB_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismReaders.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "VTK::CommonCore;VTK::CommonDataModel;VTK::CommonMisc;VTK::FiltersGeometry"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismReaders.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS Prism::vtkPrismReaders )
list(APPEND _IMPORT_CHECK_FILES_FOR_Prism::vtkPrismReaders "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismReaders.lib" "${_IMPORT_PREFIX}/bin/paraview-6.0/plugins/Prism/vtkPrismReaders.dll" )

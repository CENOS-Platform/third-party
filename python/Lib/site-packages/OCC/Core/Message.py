...
def Message_SequenceOfPrinters_delNode(theNode, theAl):
    return _Message.Message_SequenceOfPrinters_delNode(theNode, theAl)
...
class Message_Alert(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_Alert self, int depth=-1) -> std::string"""
    ...
    def __init__(self):
        r"""__init__(Message_Alert self) -> Message_Alert"""
...
class Message_Attribute(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_Attribute self, int depth=-1) -> std::string"""
...
class Message_CompositeAlerts(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_CompositeAlerts self, int depth=-1) -> std::string"""
...
class Message_Messenger(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_Messenger self, int depth=-1) -> std::string"""
...
class Message_Report(OCC.Core.Standard.Standard_Transient):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_Report self, int depth=-1) -> std::string"""
...
class Message_AlertExtended(Message_Alert):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_AlertExtended self, int depth=-1) -> std::string"""
    ...
    def GetMessageKey(self, *args):
        ...
        """
        return _Message.Message_AlertExtended_GetMessageKey(self, *args)

    def Merge(self, *args):
        r"""
        If possible, merge data contained in this alert to thetarget. base implementation always returns false. returns true if merged.
        ...
        """
        return _Message.Message_AlertExtended_Merge(self, *args)
    ...
    def SupportsMerge(self, *args):
        ...
        """
        return _Message.Message_AlertExtended_SupportsMerge(self, *args)
...
class Message_AttributeMeter(Message_Attribute):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_AttributeMeter self, int depth=-1) -> std::string"""
...
class Message_AttributeObject(Message_Attribute):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_AttributeObject self, int depth=-1) -> std::string"""
...
class Message_AttributeStream(Message_Attribute):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(Message_AttributeStream self, int depth=-1) -> std::string"""
...
class Message_PrinterToReport(Message_Printer):
    ...
    def SendObject(self, *args):
        ...
        """
        return _Message.Message_PrinterToReport_SendObject(self, *args)
    ...
    def SendStringStream(self, *args):
        ...
        """
        return _Message.Message_PrinterToReport_SendStringStream(self, *args)

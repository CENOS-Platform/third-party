...
class GeomInt_SequenceOfParameterAndOrientation:
    ...
    def Length(self) -> int: ...
    def Append(self, theItem: GeomInt_ParameterAndOrientation) -> GeomInt_ParameterAndOrientation: ...
    def Prepend(self, theItem: GeomInt_ParameterAndOrientation) -> GeomInt_ParameterAndOrientation: ...
    def RemoveFirst(self) -> None: ...
    def Reverse(self) -> None: ...
    def Value(self, theIndex: int) -> GeomInt_ParameterAndOrientation: ...
    def SetValue(self, theIndex: int, theValue: GeomInt_ParameterAndOrientation) -> None: ...

class geomint:
    @staticmethod
    def AdjustPeriodic(thePar: float, theParMin: float, theParMax: float, thePeriod: float, theEps: Optional[float] = 0.0) -> Tuple[bool, float, float]: ...
...
class GeomInt_IntSS:
    ...
    @staticmethod
    def MakeBSpline2d(theWLine: IntPatch_WLine, ideb: int, ifin: int, onFirst: bool) -> Geom2d_BSplineCurve: ...
    def NbBoundaries(self) -> int: ...
    def NbLines(self) -> int: ...
    def NbPoints(self) -> int: ...
    @overload
    def Perform(self, S1: Geom_Surface, S2: Geom_Surface, Tol: float, Approx: Optional[bool] = True, ApproxS1: Optional[bool] = False, ApproxS2: Optional[bool] = False) -> None: ...
    @overload
    def Perform(self, HS1: GeomAdaptor_Surface, HS2: GeomAdaptor_Surface, Tol: float, Approx: Optional[bool] = True, ApproxS1: Optional[bool] = False, ApproxS2: Optional[bool] = False) -> None: ...
    @overload
    def Perform(self, S1: Geom_Surface, S2: Geom_Surface, Tol: float, U1: float, V1: float, U2: float, V2: float, Approx: Optional[bool] = True, ApproxS1: Optional[bool] = False, ApproxS2: Optional[bool] = False) -> None: ...
    @overload
    def Perform(self, HS1: GeomAdaptor_Surface, HS2: GeomAdaptor_Surface, Tol: float, U1: float, V1: float, U2: float, V2: float, Approx: Optional[bool] = True, ApproxS1: Optional[bool] = False, ApproxS2: Optional[bool] = False) -> None: ...
    ...
    @staticmethod
    def TreatRLine(theRL: IntPatch_RLine, theHS1: GeomAdaptor_Surface, theHS2: GeomAdaptor_Surface, theC3d: Geom_Curve, theC2d1: Geom2d_Curve, theC2d2: Geom2d_Curve) -> float: ...
    @staticmethod
    def TrimILineOnSurfBoundaries(theC2d1: Geom2d_Curve, theC2d2: Geom2d_Curve, theBound1: Bnd_Box2d, theBound2: Bnd_Box2d, theArrayOfParameters: GeomInt_VectorOfReal) -> None: ...

class GeomInt_LineConstructor:
    def __init__(self) -> None: ...
    def IsDone(self) -> bool: ...
    def Load(self, D1: Adaptor3d_TopolTool, D2: Adaptor3d_TopolTool, S1: GeomAdaptor_Surface, S2: GeomAdaptor_Surface) -> None: ...
...
class GeomInt_LineTool:
    @staticmethod
    def DecompositionOfWLine(theWLine: IntPatch_WLine, theSurface1: GeomAdaptor_Surface, theSurface2: GeomAdaptor_Surface, aTolSum: float, theLConstructor: GeomInt_LineConstructor, theNewLines: IntPatch_SequenceOfLine) -> bool: ...
    @staticmethod
...
class GeomInt_MyBSplGradientOfTheComputeLineOfWLApprox:
    @overload
    def __init__(self, SSP: GeomInt_TheMultiLineOfWLApprox, FirstPoint: int, LastPoint: int, TheConstraints: AppParCurves_HArray1OfConstraintCouple, Parameters: math_Vector, Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, Deg: int, Tol3d: float, Tol2d: float, NbIterations: Optional[int] = 1) -> None: ...
    @overload
...
class GeomInt_MyGradientOfTheComputeLineBezierOfWLApprox:
    def __init__(self, SSP: GeomInt_TheMultiLineOfWLApprox, FirstPoint: int, LastPoint: int, TheConstraints: AppParCurves_HArray1OfConstraintCouple, Parameters: math_Vector, Deg: int, Tol3d: float, Tol2d: float, NbIterations: Optional[int] = 200) -> None: ...
    def AverageError(self) -> float: ...
    def Error(self, Index: int) -> float: ...
    def IsDone(self) -> bool: ...
    def MaxError2d(self) -> float: ...
...
class GeomInt_ResConstraintOfMyGradientOfTheComputeLineBezierOfWLApprox:
    def __init__(self, SSP: GeomInt_TheMultiLineOfWLApprox, SCurv: AppParCurves_MultiCurve, FirstPoint: int, LastPoint: int, Constraints: AppParCurves_HArray1OfConstraintCouple, Bern: math_Matrix, DerivativeBern: math_Matrix, Tolerance: Optional[float] = 1.0e-10) -> None: ...
...
class GeomInt_TheComputeLineBezierOfWLApprox:
    ...
    @overload
    def __init__(self, Line: GeomInt_TheMultiLineOfWLApprox, Parameters: math_Vector, degreemin: Optional[int] = 4, degreemax: Optional[int] = 8, Tolerance3d: Optional[float] = 1.0e-03, Tolerance2d: Optional[float] = 1.0e-06, NbIterations: Optional[int] = 5, cutting: Optional[bool] = True, Squares: Optional[bool] = False) -> None: ...
    @overload
...
class GeomInt_TheMultiLineOfWLApprox:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, line: IntPatch_WLine, PtrSvSurfaces: None, NbP3d: int, NbP2d: int, ApproxU1V1: bool, ApproxU2V2: bool, xo: float, yo: float, zo: float, u1o: float, v1o: float, u2o: float, v2o: float, P2DOnFirst: bool, IndMin: Optional[int] = 0, IndMax: Optional[int] = 0) -> None: ...
    @overload
    def __init__(self, line: IntPatch_WLine, NbP3d: int, NbP2d: int, ApproxU1V1: bool, ApproxU2V2: bool, xo: float, yo: float, zo: float, u1o: float, v1o: float, u2o: float, v2o: float, P2DOnFirst: bool, IndMin: Optional[int] = 0, IndMax: Optional[int] = 0) -> None: ...
    def Dump(self) -> None: ...
...
class GeomInt_TheMultiLineToolOfWLApprox:
    @overload
    @staticmethod
    def Curvature(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabV: TColgp_Array1OfVec) -> bool: ...
    @overload
    @staticmethod
    def Curvature(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabV2d: TColgp_Array1OfVec2d) -> bool: ...
    @overload
    @staticmethod
    def Curvature(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabV: TColgp_Array1OfVec, tabV2d: TColgp_Array1OfVec2d) -> bool: ...
    @staticmethod
    ...
    @overload
    @staticmethod
    def Tangency(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabV: TColgp_Array1OfVec) -> bool: ...
    @overload
    @staticmethod
    def Tangency(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabV2d: TColgp_Array1OfVec2d) -> bool: ...
    @overload
    @staticmethod
    def Tangency(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabV: TColgp_Array1OfVec, tabV2d: TColgp_Array1OfVec2d) -> bool: ...
    @overload
    @staticmethod
    def Value(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabPt: TColgp_Array1OfPnt) -> None: ...
    @overload
    @staticmethod
    def Value(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabPt2d: TColgp_Array1OfPnt2d) -> None: ...
    @overload
    @staticmethod
    def Value(ML: GeomInt_TheMultiLineOfWLApprox, MPointIndex: int, tabPt: TColgp_Array1OfPnt, tabPt2d: TColgp_Array1OfPnt2d) -> None: ...
    @staticmethod
    def WhatStatus(ML: GeomInt_TheMultiLineOfWLApprox, I1: int, I2: int) -> Approx_Status: ...

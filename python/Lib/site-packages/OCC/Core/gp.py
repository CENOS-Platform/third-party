...
def gp_Vec3f_Cross(theVec1, theVec2):
    return _gp.gp_Vec3f_Cross(theVec1, theVec2)

def gp_Vec3f_GetLERP(theFrom, theTo, theT):
    return _gp.gp_Vec3f_GetLERP(theFrom, theTo, theT)
...
class gp_Ax1(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Ax1 self, int depth=-1) -> std::string"""
        return _gp.gp_Ax1_DumpJsonToString(self, depth)

    def InitFromJson(self, *args):
        r"""
...
class gp_Ax2(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Ax2 self, int depth=-1) -> std::string"""
...
class gp_Ax22d(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Ax22d self, int depth=-1) -> std::string"""
...
class gp_Ax2d(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Ax2d self, int depth=-1) -> std::string"""
...
class gp_Ax3(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Ax3 self, int depth=-1) -> std::string"""
...
class gp_Dir(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Dir self, int depth=-1) -> std::string"""
...
class gp_Dir2d(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Dir2d self, int depth=-1) -> std::string"""
...
class gp_GTrsf(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_GTrsf self, int depth=-1) -> std::string"""
    ...
    def __imul_wrapper__(self, other):
        r"""__imul_wrapper__(gp_GTrsf self, gp_GTrsf other)"""
...
class gp_Pln(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Pln self, int depth=-1) -> std::string"""
...
class gp_Pnt(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Pnt self, int depth=-1) -> std::string"""
...
class gp_Pnt2d(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Pnt2d self, int depth=-1) -> std::string"""
...
class gp_Vec(object):
    ...
    def DumpJsonToString(self, depth=-1):
        r"""DumpJsonToString(gp_Vec self, int depth=-1) -> std::string"""
    ...
    def __imul_wrapper__(self, other):
        r"""__imul_wrapper__(gp_Vec self, Standard_Real const other)"""
    ...
    def __iadd_wrapper__(self, other):
        r"""__iadd_wrapper__(gp_Vec self, gp_Vec other)"""
    ...
    def __isub_wrapper__(self, other):
        r"""__isub_wrapper__(gp_Vec self, gp_Vec other)"""
    ...
    def __itruediv_wrapper__(self, other):
        r"""__itruediv_wrapper__(gp_Vec self, Standard_Real const other)"""
...
class gp_XY(object):
    ...
    def Add(self, *args):
        r"""
        Computes the sum of this number pair and number pair theother @code <self>.x() = <self>.x() + theother.x() <self>.y() = <self>.y() + theother.y().
    ...
    def Multiplied(self, *args):
        r"""
        @code new.x() = <self>.x() * thescalar; new.y() = <self>.y() * thescalar;.
        ...
        -------
        gp_XY
        @code new.x() = <self>.x() * theother.x(); new.y() = <self>.y() * theother.y();.
    ...
    def Multiply(self, *args):
        r"""
        @code <self>.x() = <self>.x() * thescalar; <self>.y() = <self>.y() * thescalar;.
        ...
        -------
        None
        @code <self>.x() = <self>.x() * theother.x(); <self>.y() = <self>.y() * theother.y();.
    ...
    def Reversed(self, *args):
        r"""
        @code new.x() = -<self>.x() new.y() = -<self>.y().
    ...
    def SetLinearForm(self, *args):
        r"""
        Computes the following linear combination and assigns the result to this number pair: @code thea1 * thexy1 + thea2 * thexy2.
        ...
        -------
        None
        -- computes the following linear combination and assigns the result to this number pair: @code thea1 * thexy1 + thea2 * thexy2 + thexy3.
        ...
        -------
        None
        Computes the following linear combination and assigns the result to this number pair: @code thea1 * thexy1 + thexy2.
        ...
        -------
        None
        Computes the following linear combination and assigns the result to this number pair: @code thexy1 + thexy2.
...
class gp_XYZ(object):
    ...
    def Add(self, *args):
        r"""
        @code <self>.x() = <self>.x() + theother.x() <self>.y() = <self>.y() + theother.y() <self>.z() = <self>.z() + theother.z().
    ...
    def Cross(self, *args):
        r"""
        @code <self>.x() = <self>.y() * theother.z() - <self>.z() * theother.y() <self>.y() = <self>.z() * theother.x() - <self>.x() * theother.z() <self>.z() = <self>.x() * theother.y() - <self>.y() * theother.x().
    ...
    def Multiplied(self, *args):
        r"""
        @code new.x() = <self>.x() * thescalar; new.y() = <self>.y() * thescalar; new.z() = <self>.z() * thescalar;.
        ...
        -------
        gp_XYZ
        @code new.x() = <self>.x() * theother.x(); new.y() = <self>.y() * theother.y(); new.z() = <self>.z() * theother.z();.
    ...
    def Multiply(self, *args):
        r"""
        @code <self>.x() = <self>.x() * thescalar; <self>.y() = <self>.y() * thescalar; <self>.z() = <self>.z() * thescalar;.
    ...
    def Reverse(self, *args):
        r"""
        @code <self>.x() = -<self>.x() <self>.y() = -<self>.y() <self>.z() = -<self>.z().
    ...
    def Reversed(self, *args):
        r"""
        @code new.x() = -<self>.x() new.y() = -<self>.y() new.z() = -<self>.z().
    ...
    def SetLinearForm(self, *args):
        r"""
        <self> is set to the following linear form : @code thea1 * thexyz1 + thea2 * thexyz2 + thea3 * thexyz3 + thexyz4.
        ...
        -------
        None
        <self> is set to the following linear form : @code thea1 * thexyz1 + thea2 * thexyz2 + thea3 * thexyz3.
        ...
        -------
        None
        <self> is set to the following linear form : @code thea1 * thexyz1 + thea2 * thexyz2 + thexyz3.
        ...
        -------
        None
        <self> is set to the following linear form : @code thea1 * thexyz1 + thea2 * thexyz2.
        ...
        -------
        None
        <self> is set to the following linear form : @code thea1 * thexyz1 + thexyz2.
        ...
        -------
        None
        <self> is set to the following linear form : @code thexyz1 + thexyz2.

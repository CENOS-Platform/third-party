(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["trame_simput"] = factory();
	else
		root["trame_simput"] = factory();
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/components/Simput/template.html?vue&type=template&id=6a399eca&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._t("default")}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Simput/template.html?vue&type=template&id=6a399eca&
...
// CONCATENATED MODULE: ./src/core/types.js
...
var COMPUTED = {
  query: {
    textToQuery: function textToQuery() {
      var _this$name, _this$label;

      // ${this.help?.toLowerCase() || ''}
      return "".concat(((_this$name = this.name) === null || _this$name === void 0 ? void 0 : _this$name.toLowerCase()) || '', " ").concat(((_this$label = this.label) === null || _this$label === void 0 ? void 0 : _this$label.toLowerCase()) || '');
    },
  ...
  hints: {
    hints: function hints() {
      var _this$domains, _this$domains$this$na3;

      /* eslint-disable no-unused-expressions */
      this.mtime; // force refresh

      return ((_this$domains = this.domains()) === null || _this$domains === void 0 ? void 0 : (_this$domains$this$na3 = _this$domains[this.name]) === null || _this$domains$this$na3 === void 0 ? void 0 : _this$domains$this$na3.hints) || [];
    }
  },
  rule: {
    rule: function rule() {
      ...
      return ((_TYPES$this$type2 = TYPES[this.type]) === null || _TYPES$this$type2 === void 0 ? void 0 : _TYPES$this$type2.rule) || function () {
        return true;
      };
    }
  }
...
var utils_DataManager = /*#__PURE__*/function () {
  function DataManager(namespace, wsClient) {
    ...
    this.subscription = this.wsClient.getConnection().getSession().subscribe('simput.push', function (_ref) {
      ...
      if (data) {
        delete _this2.pendingData[id];
        delete _this2.pendingDirtyData[id];
        var before = JSON.stringify(_this2.expectedServerProps[id]);
        var after = JSON.stringify(data.properties);

        if (before !== after) {
          idChange = true;
          _this2.cache.data[id] = data;

          if (before == undefined) {
            _this2.expectedServerProps[id] = JSON.parse(JSON.stringify(data.properties)); // deep copy
        ...
        _this2.cache.data[id].mtime = data.mtime;
        _this2.cache.data[id].original = JSON.parse(after);
      }

      if (domains) {
        delete _this2.pendingDomain[id];

        var _before = JSON.stringify(_this2.cache.domains[id]);
        ...
        if (_before !== _after) {
          idChange = true;
          _this2.cache.domains[id] = domains; // console.log(`domains(${id}) == CHANGE`);
          // } else {
      ...
      if (ui) {
        uiChange = true; // console.log(`ui(${type})`);

        delete _this2.pendingUI[type];
        _this2.cache.ui[type] = ui;
      }
      ...
      _this2.notify('change', notifyPayload);

      if (ui) {
        _this2.nextTS += 1;

        _this2.notify('templateTS');
      }

      _this2.flushDirtySet();
    });
    this.subscriptionUI = this.wsClient.getConnection().getSession().subscribe('simput.event', function (_ref3) {
      ...
      if (event.topic === 'ui-change') {
        var typesToFetch = Object.keys(_this2.cache.ui);
        _this2.cache.ui = {};

        for (var i = 0; i < typesToFetch.length; i++) {
          _this2.getUI(typesToFetch[i]);
        }
      }
      ...
      if (event.topic === 'data-change') {
        ...
        for (var _i = 0; _i < ids.length; _i++) {
          if (_this2.cache.data[ids[_i]]) {
            if (action === 'changed') {
              // console.log('getData from data-change', ids[i]);
              _this2.getData(ids[_i], true);
            }
          }
        }
      }
    ...
    this.onDirty = function (_ref5) {
      ...
      if (name) {
        var value = _this2.cache.data[id].properties[name];

        var idx = _this2.dirtySet.findIndex(function (e) {
          return e.id === id && e.name === name;
        });

        if (idx > -1) _this2.dirtySet.splice(idx, 1);

        _this2.dirtySet.push({
          id: id,
          name: name,
          value: value
        });
  ...
  _createClass(DataManager, [{
    key: "flushDirtySet",
    value: function () {
      var _flushDirtySet = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this3 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                this.dirtySet = [];
                dirtySet.forEach(function (_ref6) {
                  var id = _ref6.id,
                      name = _ref6.name,
                      value = _ref6.value;
                  _this3.expectedServerProps[id][name] = value;
                  _this3.pendingDirtyData[id] = true;
                }); // console.log('sending: ', dirtySet);

                _context.next = 9;
                return this.wsClient.getRemote().Trame.trigger("".concat(this.namespace, "Update"), [dirtySet]);
      ...
      function flushDirtySet() {
        return _flushDirtySet.apply(this, arguments);
      }

      return flushDirtySet;
    }()
  }, {
    key: "resetCache",
    value: function resetCache() {
      ...
      this.wsClient.getRemote().Trame.trigger("".concat(this.namespace, "ResetCache"), []);
    }
  }, {
    key: "resetDomains",
    ...
    value: function getData(id) {
      ...
      if ((!data || forceFetch) && !this.pendingData[id]) {
        ...
        this.wsClient.getRemote().Trame.trigger("".concat(this.namespace, "Fetch"), [], {
          id: id
        });
      }
    ...
    value: function refresh(id, name) {
      ...
      this.wsClient.getRemote().Trame.trigger("".concat(this.namespace, "Refresh"), [id, name]);
    }
  }]);
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/components/Simput/script.js?vue&type=script&lang=js&
...
/* harmony default export */ var scriptvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    this.updateManager();
    this.pushQuery = debounce(function () {
      var _this$query;

      return _this.$emit('query', ((_this$query = _this.query) === null || _this$query === void 0 ? void 0 : _this$query.toLowerCase()) || '');
    }, 250);
  },
  ...
  methods: {
    updateManager: function updateManager() {
      ...
      this.managerId = this.trame.state.get("".concat(this.namespace, "Id"));
      this.manager = getSimputManager(this.managerId, this.namespace, this.client);
  ...
  provide: function provide() {
    ...
    return {
      ...
      getSimput: function getSimput() {
        return _this2.manager;
      }
    };
  },
  inject: ['trame']
});
// CONCATENATED MODULE: ./src/components/Simput/script.js?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/components/Simput/index.vue
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/components/SimputItem/template.html?vue&type=template&id=f0c6b8f0&
var templatevue_type_template_id_f0c6b8f0_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.available)?_c('div',[(!_vm.noUi)?_c('v-runtime-template',{attrs:{"template":_vm.ui}}):_vm._e(),_vm._t("default",null,null,_vm.all),_vm._t("properties",null,null,_vm.properties)],2):_vm._e()}
var templatevue_type_template_id_f0c6b8f0_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/SimputItem/template.html?vue&type=template&id=f0c6b8f0&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/components/SimputItem/script.js?vue&type=script&lang=js&
...
/* harmony default export */ var SimputItem_scriptvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    this.onReload = function (name) {
      if (name === 'data') {
        _this.data = _this.getSimput().getData(_this.proxyId, true);
      }

      if (name === 'ui') {
        _this.ui = _this.getSimput().getUI(_this.proxyId, true);
      }

      if (name === 'domain') {
        _this.getSimput().resetDomains();

        _this.domains = _this.getSimput().getDomains(_this.proxyId, true);
      }
    };
  ...
  computed: {
    proxyId: function proxyId() {
      return "".concat(this.itemId);
    },
    type: function type() {
  ...
  methods: {
    ...
    dirtyMany: function dirtyMany(names) {
      this.simputChannel.$emit('dirty', {
        id: this.data.id,
        names: names
      });
  ...
  provide: function provide() {
    ...
    return {
      ...
      dirtyMany: function dirtyMany() {
        for (var _len = arguments.length, names = new Array(_len), _key = 0; _key < _len; _key++) {
          names[_key] = arguments[_key];
        }

        return _this2.dirtyMany(names);
      },
      data: function data() {
        return _this2.data;
      },
...
// CONCATENATED MODULE: ./src/components/SimputItem/script.js?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/components/SimputItem/index.vue
...
var SimputItem_component = normalizeComponent(
  ...
  templatevue_type_template_id_f0c6b8f0_render,
  templatevue_type_template_id_f0c6b8f0_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Select/template.html?vue&type=template&id=5cf09324&
var templatevue_type_template_id_5cf09324_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-col',{directives:[{name:"show",rawName:"v-show",value:(_vm.shouldShow),expression:"shouldShow"}],staticClass:"py-0"},[_c('v-select',{key:_vm.tsKey,attrs:{"label":_vm.label,"hint":_vm.computedHelp,"items":_vm.computedItems,"multiple":_vm.multiple,"persistent-hint":!!(_vm.useRangeHelp || _vm.help),"disabled":_vm.disabled || !_vm.decorator.enable,"readonly":_vm.readonly},on:{"change":_vm.validate},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v},expression:"model"}})],1)}
var templatevue_type_template_id_5cf09324_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Select/template.html?vue&type=template&id=5cf09324&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Select/script.js?vue&type=script&lang=js&
...
/* harmony default export */ var Select_scriptvue_type_script_lang_js_ = ({
  ...
  computed: _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, COMPUTED.query), COMPUTED.decorator), COMPUTED.convert), {}, {
    textToQuery: function textToQuery() {
      var _this$name, _this$label, _this$help;

      return "".concat(((_this$name = this.name) === null || _this$name === void 0 ? void 0 : _this$name.toLowerCase()) || '', " ").concat(((_this$label = this.label) === null || _this$label === void 0 ? void 0 : _this$label.toLowerCase()) || '', " ").concat(((_this$help = this.help) === null || _this$help === void 0 ? void 0 : _this$help.toLowerCase()) || '', " ").concat(JSON.stringify(this.computedItems));
    },
    model: {
      get: function get() {
        /* eslint-disable no-unused-expressions */
...
// CONCATENATED MODULE: ./src/widgets/Select/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Select_scriptvue_type_script_lang_js_ = (Select_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Select/index.vue
...
var Select_component = normalizeComponent(
  ...
  templatevue_type_template_id_5cf09324_render,
  templatevue_type_template_id_5cf09324_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Slider/template.html?vue&type=template&id=32222969&
var templatevue_type_template_id_32222969_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{directives:[{name:"show",rawName:"v-show",value:(_vm.shouldShow),expression:"shouldShow"}],staticStyle:{"position":"relative"},attrs:{"fluid":""}},[_c('div',{staticStyle:{"position":"absolute","right":"10px","top":"-1px","z-index":"1"}},[(_vm.help && _vm.size > 1)?_c('v-btn',{attrs:{"icon":"","x-small":""},on:{"click":function($event){_vm.showHelp = !_vm.showHelp}}},[_c('v-icon',{attrs:{"small":""}},[_vm._v("mdi-lifebuoy")])],1):_vm._e(),(_vm.computedSizeControl)?_c('v-btn',{attrs:{"icon":"","x-small":""},on:{"click":_vm.addEntry}},[_c('v-icon',{attrs:{"small":""}},[_vm._v("mdi-plus-circle-outline")])],1):_vm._e()],1),_c('v-row',[(_vm.label && _vm.size != 1)?_c('v-col',{staticClass:"py-0"},[_c('div',{staticClass:"text-caption text--secondary"},[_vm._v(_vm._s(_vm.label))]),_c('v-divider'),(_vm.help && _vm.showHelp)?_c('div',{staticClass:"text-caption text--secondary"},[_vm._v(" "+_vm._s(_vm.help)+" ")]):_vm._e()],1):_vm._e()],1),(_vm.model != null)?_c('v-row',[(_vm.size == 1)?_c('v-col',{staticClass:"pt-0 pb-1"},[_c('v-row',{staticClass:"align-center",attrs:{"no-gutters":""}},[_c('v-col',{staticClass:"text-truncate text--secondary",attrs:{"cols":"9"}},[_vm._v(" "+_vm._s(_vm.label)+" ")]),_c('v-col',{staticClass:"text-truncate text-right text-caption text--secondary"},[_vm._v(" "+_vm._s(_vm.model)+" ")]),(_vm.help)?_c('v-btn',{attrs:{"icon":"","x-small":""},on:{"click":function($event){_vm.showHelp = !_vm.showHelp}}},[_c('v-icon',{attrs:{"small":""}},[_vm._v("mdi-lifebuoy")])],1):_vm._e()],1),_c('v-slider',{attrs:{"name":((_vm.data().type) + ":" + _vm.name + ":" + _vm.i),"hide-details":"","dense":"","rules":[_vm.rule],"min":_vm.computedMin,"max":_vm.computedMax,"step":_vm.computedStep,"disabled":_vm.disabled || !_vm.decorator.enable,"readonly":_vm.readonly},on:{"change":function($event){return _vm.validate()}},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v},expression:"model"}}),(_vm.help && _vm.showHelp)?_c('div',{staticClass:"mt-0 mb-2 text-caption text--secondary"},[_vm._v(" "+_vm._s(_vm.help)+" ")]):_vm._e(),_vm._l((_vm.hints),function(hint,idx){return _c('v-alert',{key:idx,staticClass:"mb-1",attrs:{"type":_vm.levelToType(hint.level),"border":"left","dense":"","icon":_vm.levelToIcon(hint.level)}},[_vm._v(" "+_vm._s(hint.message)+" ")])})],2):_vm._e(),_vm._l((_vm.computedSize),function(i){return (_vm.size != 1)?_c('v-col',_vm._b({key:i,staticClass:"py-1"},'v-col',_vm.getComponentProps(i-1),false),[_c('v-row',{staticClass:"align-center",attrs:{"no-gutters":""}},[_c('v-slider',{staticClass:"mt-0",attrs:{"name":((_vm.data().type) + ":" + _vm.name + ":" + i),"hide-details":"","dense":"","rules":[_vm.rule],"min":_vm.computedMin,"max":_vm.computedMax,"step":_vm.computedStep,"disabled":_vm.disabled || !_vm.decorator.enable,"readonly":_vm.readonly},on:{"change":function($event){return _vm.validate(i)}},model:{value:(_vm.model[i - 1]),callback:function ($$v) {_vm.$set(_vm.model, i - 1, $$v)},expression:"model[i - 1]"}}),_c('div',{staticClass:"text-truncate text-right text-caption text--secondary",staticStyle:{"max-width":"60px","min-width":"60px"}},[_vm._v(_vm._s(_vm.model[i - 1]))]),(_vm.computedSizeControl)?_c('v-btn',{staticClass:"ml-2",attrs:{"icon":"","x-small":"","disabled":!_vm.decorator.enable},on:{"click":function($event){return _vm.deleteEntry(i - 1)}}},[_c('v-icon',[_vm._v("mdi-minus-circle-outline")])],1):_vm._e()],1),_vm._l((_vm.hints),function(hint,idx){return _c('v-alert',{key:idx,staticClass:"mb-1",attrs:{"type":_vm.levelToType(hint.level),"border":"left","dense":"","icon":_vm.levelToIcon(hint.level)}},[_vm._v(" "+_vm._s(hint.message)+" ")])})],2):_vm._e()})],2):_vm._e()],1)}
var templatevue_type_template_id_32222969_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Slider/template.html?vue&type=template&id=32222969&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Slider/script.js?vue&type=script&lang=js&
...
/* harmony default export */ var Slider_scriptvue_type_script_lang_js_ = ({
  ...
  computed: _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, COMPUTED.query), COMPUTED.decorator), COMPUTED.convert), COMPUTED.rule), COMPUTED.hints), {}, {
    model: {
      get: function get() {
        /* eslint-disable no-unused-expressions */
        this.mtime; // force refresh
    ...
    computedMin: function computedMin() {
      var _this$domains, _this$domains$this$na5, _this$domains$this$na6, _this$domains2, _this$domains2$this$n, _this$domains2$this$n2;

      if (this.min != null) {
        return this.min;
      }

      var dataRange = ((_this$domains = this.domains()) === null || _this$domains === void 0 ? void 0 : (_this$domains$this$na5 = _this$domains[this.name]) === null || _this$domains$this$na5 === void 0 ? void 0 : (_this$domains$this$na6 = _this$domains$this$na5.Range) === null || _this$domains$this$na6 === void 0 ? void 0 : _this$domains$this$na6.available) || ((_this$domains2 = this.domains()) === null || _this$domains2 === void 0 ? void 0 : (_this$domains2$this$n = _this$domains2[this.name]) === null || _this$domains2$this$n === void 0 ? void 0 : (_this$domains2$this$n2 = _this$domains2$this$n.range) === null || _this$domains2$this$n2 === void 0 ? void 0 : _this$domains2$this$n2.available);
...
// CONCATENATED MODULE: ./src/widgets/Slider/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Slider_scriptvue_type_script_lang_js_ = (Slider_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Slider/index.vue
...
var Slider_component = normalizeComponent(
  ...
  templatevue_type_template_id_32222969_render,
  templatevue_type_template_id_32222969_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Switch/template.html?vue&type=template&id=95b03d94&
var templatevue_type_template_id_95b03d94_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-col',{directives:[{name:"show",rawName:"v-show",value:(_vm.shouldShow),expression:"shouldShow"}]},[_c('v-row',{staticClass:"ma-0 align-center",staticStyle:{"position":"relative"}},[_c('v-switch',{staticClass:"py-0 mt-0",attrs:{"label":_vm.label,"hint":_vm.help,"dense":"","hide-details":"","disabled":_vm.disabled || !_vm.decorator.enable,"readonly":_vm.readonly},on:{"change":_vm.validate},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v},expression:"model"}}),_c('v-spacer'),(_vm.help)?_c('v-btn',{staticStyle:{"position":"absolute","right":"0"},attrs:{"icon":"","x-small":""},on:{"click":function($event){_vm.showHelp = !_vm.showHelp}}},[_c('v-icon',{attrs:{"small":""}},[_vm._v("mdi-lifebuoy")])],1):_vm._e()],1),(_vm.help && _vm.showHelp)?_c('v-row',{staticClass:"ma-0 text-caption text--secondary"},[_vm._v(" "+_vm._s(_vm.help)+" ")]):_vm._e()],1)}
var templatevue_type_template_id_95b03d94_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Switch/template.html?vue&type=template&id=95b03d94&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Switch/script.js?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/widgets/Switch/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Switch_scriptvue_type_script_lang_js_ = (Switch_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Switch/index.vue
...
var Switch_component = normalizeComponent(
  ...
  templatevue_type_template_id_95b03d94_render,
  templatevue_type_template_id_95b03d94_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/TextArea/template.html?vue&type=template&id=47a02d90&
var templatevue_type_template_id_47a02d90_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-textarea',{directives:[{name:"show",rawName:"v-show",value:(_vm.decorator.show),expression:"decorator.show"}],attrs:{"label":_vm.label,"hint":_vm.help,"auto-grow":_vm.auto-_vm.grow,"autofocus":_vm.autofocus,"clearable":_vm.clearable,"readonly":_vm.readonly,"no-resize":_vm.no-_vm.resize,"row-height":_vm.row-_vm.height,"rows":_vm.rows,"disabled":_vm.disabled || !_vm.decorator.enable},on:{"change":_vm.validate},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v},expression:"model"}})}
var templatevue_type_template_id_47a02d90_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/TextArea/template.html?vue&type=template&id=47a02d90&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/TextArea/script.js?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/widgets/TextArea/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_TextArea_scriptvue_type_script_lang_js_ = (TextArea_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/TextArea/index.vue
...
var TextArea_component = normalizeComponent(
  ...
  templatevue_type_template_id_47a02d90_render,
  templatevue_type_template_id_47a02d90_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var TextField_scriptvue_type_script_lang_js_ = ({
  ...
  computed: _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, COMPUTED.query), COMPUTED.decorator), COMPUTED.convert), COMPUTED.hints), COMPUTED.rule), {}, {
    model: {
      get: function get() {
        /* eslint-disable no-unused-expressions */
        this.mtime; // force refresh
...
// CONCATENATED MODULE: ./src/widgets/TextField/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_TextField_scriptvue_type_script_lang_js_ = (TextField_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/TextField/index.vue
...
var TextField_component = normalizeComponent(
  ...
  templatevue_type_template_id_c379b242_render,
  templatevue_type_template_id_c379b242_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Proxy/template.html?vue&type=template&id=253f4e1e&
var templatevue_type_template_id_253f4e1e_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('SimputInput',{directives:[{name:"show",rawName:"v-show",value:(_vm.decorator.show),expression:"decorator.show"}],attrs:{"itemId":_vm.itemId}})}
var templatevue_type_template_id_253f4e1e_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Proxy/template.html?vue&type=template&id=253f4e1e&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Proxy/script.js?vue&type=script&lang=js&
...
/* harmony default export */ var Proxy_scriptvue_type_script_lang_js_ = ({
  ...
  computed: _objectSpread2(_objectSpread2({}, COMPUTED.decorator), {}, {
    itemId: function itemId() {
      /* eslint-disable no-unused-expressions */
      this.mtime; // force refresh
...
// CONCATENATED MODULE: ./src/widgets/Proxy/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Proxy_scriptvue_type_script_lang_js_ = (Proxy_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Proxy/index.vue
...
var Proxy_component = normalizeComponent(
  ...
  templatevue_type_template_id_253f4e1e_render,
  templatevue_type_template_id_253f4e1e_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Show/template.html?vue&type=template&id=3e822ce6&
var templatevue_type_template_id_3e822ce6_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}]},[_vm._t("default")],2)}
var templatevue_type_template_id_3e822ce6_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Show/template.html?vue&type=template&id=3e822ce6&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Show/script.js?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/widgets/Show/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Show_scriptvue_type_script_lang_js_ = (Show_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Show/index.vue
...
var Show_component = normalizeComponent(
  ...
  templatevue_type_template_id_3e822ce6_render,
  templatevue_type_template_id_3e822ce6_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Hide/template.html?vue&type=template&id=07043bb0&
var templatevue_type_template_id_07043bb0_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}]},[_vm._t("default")],2)}
var templatevue_type_template_id_07043bb0_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Hide/template.html?vue&type=template&id=07043bb0&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Hide/script.js?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/widgets/Hide/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Hide_scriptvue_type_script_lang_js_ = (Hide_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Hide/index.vue
...
var Hide_component = normalizeComponent(
  ...
  templatevue_type_template_id_07043bb0_render,
  templatevue_type_template_id_07043bb0_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Text/template.html?vue&type=template&id=443e7d46&
var templatevue_type_template_id_443e7d46_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v(" "+_vm._s(_vm.content)+" ")])}
var templatevue_type_template_id_443e7d46_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Text/template.html?vue&type=template&id=443e7d46&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Text/script.js?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./src/widgets/Text/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Text_scriptvue_type_script_lang_js_ = (Text_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Text/index.vue
...
var Text_component = normalizeComponent(
  ...
  templatevue_type_template_id_443e7d46_render,
  templatevue_type_template_id_443e7d46_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"79cf8231-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./src/widgets/Group/template.html?vue&type=template&id=0274a56d&
var templatevue_type_template_id_0274a56d_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-col',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],staticClass:"px-0"},[_c('div',{staticClass:"text-h6 px-2"},[_vm._v(_vm._s(_vm.title))]),_c('v-divider',{staticClass:"mb-2"}),_vm._t("default")],2)}
var templatevue_type_template_id_0274a56d_staticRenderFns = []


// CONCATENATED MODULE: ./src/widgets/Group/template.html?vue&type=template&id=0274a56d&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/eslint-loader??ref--14-0!./src/widgets/Group/script.js?vue&type=script&lang=js&
...
/* harmony default export */ var Group_scriptvue_type_script_lang_js_ = ({
  name: 'swGroup',
  props: {
    title: {
      type: String
  ...
  computed: _objectSpread2(_objectSpread2({}, COMPUTED.decorator), {}, {
    visible: function visible() {
      ...
      var helper = function helper(vNode) {
        var _vNode$componentInsta, _vNode$componentInsta2, _vNode$componentInsta3;
        ...
        if (vNode.componentInstance == null) {
          ...
          vNode === null || vNode === void 0 ? void 0 : (_vNode$children = vNode.children) === null || _vNode$children === void 0 ? void 0 : _vNode$children.forEach(helper);
        }

        var show = ((_vNode$componentInsta = vNode.componentInstance) === null || _vNode$componentInsta === void 0 ? void 0 : _vNode$componentInsta.shouldShow) || ((_vNode$componentInsta2 = vNode.componentInstance) === null || _vNode$componentInsta2 === void 0 ? void 0 : (_vNode$componentInsta3 = _vNode$componentInsta2.decorator) === null || _vNode$componentInsta3 === void 0 ? void 0 : _vNode$componentInsta3.show);
      ...
      (_this$$slots$default = this.$slots["default"]) === null || _this$$slots$default === void 0 ? void 0 : _this$$slots$default.forEach(helper);
      return visibleCount > 0;
    }
  }),
  inject: ['domains']
});
// CONCATENATED MODULE: ./src/widgets/Group/script.js?vue&type=script&lang=js&
 /* harmony default export */ var widgets_Group_scriptvue_type_script_lang_js_ = (Group_scriptvue_type_script_lang_js_); 
// CONCATENATED MODULE: ./src/widgets/Group/index.vue
...
var Group_component = normalizeComponent(
  widgets_Group_scriptvue_type_script_lang_js_,
  templatevue_type_template_id_0274a56d_render,
  templatevue_type_template_id_0274a56d_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./src/widgets/index.js
...
//# sourceMappingURL=vue-trame_simput.umd.js.map
...
cdef int _cuPythonInit() except -1 nogil:
    ...
    with gil, __symbol_lock:
        ...
        if usePTDS:
            ...
            global __cuStreamGetDevResource
            __cuStreamGetDevResource = windll.GetProcAddress(handle, 'cuStreamGetDevResource_ptsz')
        else:
            # Else get the regular version
            pass
            global __cuMemcpy
            ...
            global __cuStreamGetDevResource
            __cuStreamGetDevResource = windll.GetProcAddress(handle, 'cuStreamGetDevResource')
        # Get remaining functions
        global __cuGetErrorString
        ...
        global __cuGraphNodeGetContainingGraph
        __cuGraphNodeGetContainingGraph = windll.GetProcAddress(handle, 'cuGraphNodeGetContainingGraph')
        global __cuGraphNodeGetLocalId
        __cuGraphNodeGetLocalId = windll.GetProcAddress(handle, 'cuGraphNodeGetLocalId')
        global __cuGraphNodeGetToolsId
        __cuGraphNodeGetToolsId = windll.GetProcAddress(handle, 'cuGraphNodeGetToolsId')
        global __cuGraphGetId
        __cuGraphGetId = windll.GetProcAddress(handle, 'cuGraphGetId')
        global __cuGraphExecGetId
        __cuGraphExecGetId = windll.GetProcAddress(handle, 'cuGraphExecGetId')
        global __cuGraphGetNodes
        ...
        global __cuDevSmResourceSplit
        __cuDevSmResourceSplit = windll.GetProcAddress(handle, 'cuDevSmResourceSplit')
        global __cuDevResourceGenerateDesc

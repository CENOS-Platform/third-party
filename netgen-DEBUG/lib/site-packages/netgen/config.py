...
BUILD_STUB_FILES    = _cmake_to_bool("False")
...
USE_NATIVE_ARCH     = _cmake_to_bool("False")
USE_NUMA            = _cmake_to_bool("OFF")
USE_OCC             = _cmake_to_bool("True")
USE_PYTHON          = _cmake_to_bool("ON")
USE_SPDLOG          = _cmake_to_bool("OFF")

CMAKE_INSTALL_PREFIX  = "D:/SOURCE/netgen/out/install/x64-Debug"
...
ngcore_compile_definitions = "NETGEN_PYTHON;NG_PYTHON;_WIN32_WINNT=0x1000;WNT;WNT_WINDOW;NOMINMAX;MSVC_EXPRESS;_CRT_SECURE_NO_WARNINGS;HAVE_STRUCT_TIMESPEC;WIN32;NETGEN_ENABLE_CHECK_RANGE"

NETGEN_VERSION = "6.2.2203-28-g0402ca07"
NETGEN_VERSION_GIT = "v6.2.2203-28-g0402ca07"

set(PACKAGE_VERSION "6.2.2301-1-g2b56fd2ea")
...
set(NGSOLVE_MKL_LIBRARIES "E:/source/cenos/backend/third-party/python/Library/lib/mkl_rt.lib")
...
set(NGSOLVE_TK_INCLUDE_PATH "E:/source/third-party-auto/Netgen-Release/include")
set(NGSOLVE_TK_LIBRARY "E:/source/third-party-auto/Netgen-Release/lib/tkstub86.lib")
set(NGSOLVE_X11_X11_LIB "")
set(NGSOLVE_X11_Xmu_LIB "")
set(NGSOLVE_ZLIB_INCLUDE_DIRS "E:/source/third-party-auto/Netgen-Release/include")
set(NGSOLVE_ZLIB_LIBRARIES "E:/source/third-party-auto/Netgen-Release/lib/zlib.lib")
...
set(NGSOLVE_COMPILE_FLAGS " /DHAVE_NETGEN_SOURCES /DUSE_TIMEOFDAY /DTCL /DUSE_PARDISO /DLAPACK /DNGS_PYTHON /DUSE_UMFPACK /DNETGEN_PYTHON /DNG_PYTHON /D_WIN32_WINNT=0x1000 /DWNT /DWNT_WINDOW /DNOMINMAX /DMSVC_EXPRESS /D_CRT_SECURE_NO_WARNINGS /DHAVE_STRUCT_TIMESPEC /DWIN32" CACHE STRING "Preprocessor definitions of ngscxx")
set(NGSOLVE_LINK_FLAGS " -LE:/source/cenos/backend/third-party/python/Library/lib -l_rt /LIBPATH:\"%NGSCXX_DIR%/../lib\" nglib.lib ngcore.lib libngsolve.lib /LIBPATH:\"%PYTHON_LIBDIR%\"" CACHE STRING "Link flags set in ngsld")
set(NGSOLVE_INCLUDE_DIRS E:/source/cenos/backend/third-party/python/Library/include;E:/source/cenos/backend/third-party/python/include CACHE STRING "Include dirs set in ngscxx")

...
if ("${FREETYPE_PATH}" STREQUAL "")
	...
	set(FREETYPE_PATH_TMP "../../../third-party/freetype-RELEASE")
...
if ("${TCL_PATH}" STREQUAL "")
	...
	# Set third party variables, needed for newest Salome-Geom thing, used in OCCT cmake`s.
	set(TCL_PATH_TMP "../../../third-party/tcl8.6.11-RELEASE")
    set(TCL_FREETYPE_EXT "")
endif()
...
foreach(_expectedTarget TKDraw TKTopTest TKOpenGlTest TKViewerTest TKXSDRAW TKDCAF TKXDEDRAW TKTObjDRAW TKQADraw TKIVtkDraw)
...
set_target_properties(TKDraw PROPERTIES
  INTERFACE_LINK_LIBRARIES "TKernel;TKG2d;TKGeomBase;TKG3d;TKMath;TKBRep;TKGeomAlgo;TKTopAlgo;TKShHealing;TKMesh;TKService;TKHLR;${TCL_PATH_TMP}/lib/tcl86${TCL_FREETYPE_EXT};${TCL_PATH_TMP}/lib/tk86${TCL_FREETYPE_EXT};gdi32.lib;advapi32.lib;user32.lib;shell32.lib"
)
...
set_target_properties(TKViewerTest PROPERTIES
  INTERFACE_LINK_LIBRARIES "TKGeomBase;TKFillet;TKBRep;TKTopAlgo;TKHLR;TKernel;TKMath;TKService;TKShHealing;TKBool;TKPrim;TKGeomAlgo;TKG2d;TKTopTest;TKG3d;TKOffset;TKMesh;TKV3d;TKDraw;${TCL_PATH_TMP}/lib/tcl86${TCL_FREETYPE_EXT};user32.lib;gdi32.lib;${FREETYPE_PATH_TMP}/lib/freetype${TCL_FREETYPE_EXT}"
)
...
set_target_properties(TKIVtkDraw PROPERTIES
  INTERFACE_LINK_LIBRARIES "TKernel;TKBRep;TKDraw;TKG2d;TKG3d;TKGeomAlgo;TKGeomBase;TKMath;TKMesh;TKService;TKTopAlgo;TKV3d;TKOpenGl;TKIVtk;vtkIOImage;vtkImagingCore;vtkInteractionStyle;vtkRenderingOpenGL2;vtkRenderingGL2PSOpenGL2;${TCL_PATH_TMP}/lib/tcl86${TCL_FREETYPE_EXT};user32.lib"
)

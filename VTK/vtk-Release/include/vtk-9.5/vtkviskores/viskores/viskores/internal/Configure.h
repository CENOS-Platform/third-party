...
#define VISKORES_CUDA_VERSION_MINOR 
    ...
    ( defined(VISKORES_MSVC) && _MSC_VER >= 1910 ) || \
    ( defined(VISKORES_ICC)  && defined(__INTEL_CXX11_MODE__) )
#define VISKORES_HAVE_CXX_14
#else
#error "Viskores requires at least a C++14 compiler"
#endif

...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "D:/source/VTK-build/lib/cmake/vtk-9.5/viskores")
  set(Viskores_PACKAGE_IN_BUILD TRUE)
endif()

if(Viskores_PACKAGE_IN_BUILD)
  set_and_check(Viskores_CMAKE_MODULE_PATH "D:/source/third-party-builder/VTK/ThirdParty/viskores/vtkviskores/viskores/CMake")
else()
  set_and_check(Viskores_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/lib/cmake/vtk-9.5/viskores/cmake")
endif()
...
set_and_check(Viskores_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/lib/cmake/vtk-9.5/viskores")
set(VISKORES_FROM_INSTALL_DIR FALSE)
if(NOT "${CMAKE_BINARY_DIR}" STREQUAL "D:/source/VTK-build/ThirdParty/viskores/vtkviskores/viskores")
